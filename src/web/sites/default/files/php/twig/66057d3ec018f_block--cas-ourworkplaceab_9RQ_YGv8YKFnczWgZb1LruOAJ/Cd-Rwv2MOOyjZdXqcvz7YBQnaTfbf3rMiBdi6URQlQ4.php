...
class __TwigTemplate_cf6f8e9543f580ffec5cf9bca02c97ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<div{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}
  ...
  <div class=\"row our-workplace\">
    <div class=\"col-sm-6 left-work\">{{ content.field_upload_image.0 }}</div>
    <div class=\"col-sm-6 right-work\">{{ content.body.0 }}</div>
  </div>

", "themes/custom/cas/templates/block/block--cas-ourworkplaceaboutus.html.twig", "C:\\xampp\\htdocs\\cas-drupal\\web\\themes\\custom\\cas\\templates\\block\\block--cas-ourworkplaceaboutus.html.twig");
    }
